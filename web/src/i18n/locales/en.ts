...
export const en = {
  ...
  'category.explain': 'The default category sits at the top of the home screen, always open, and is where new things go. It cannot be deleted — which is what makes deleting the others safe.',
  'category.label': 'Category',
  'category.name': 'Category name',
  'category.namePlaceholder': 'New category name',
  'category.add': 'Add',
  'category.default': 'Default',
  'category.makeDefault': 'Make default',
  'category.reorder': 'Drag to reorder',
  'category.empty': 'Nothing in here yet.',
  'category.deleteTitle': 'Delete “{name}”?',
  'category.deleteEmpty': 'This category is empty, so nothing else is affected.',
  'category.deleteQuestion_one': 'It holds {count} thing. What should happen to it?',
  'category.deleteQuestion_other': 'It holds {count} things. What should happen to them?',
  'category.deleteMoveThings': 'Keep them, move to default',
  'category.deleteAlsoThings_one': 'Delete the {count} thing too',
  'category.deleteAlsoThings_other': 'Delete all {count} things too',
  ...
  'chart.filter': 'Filter',
  'chart.filterAllShown': 'all {total} shown',
  'chart.filterSomeShown': '{shown} of {total} shown',
  'chart.busiest': 'Busiest 5',
